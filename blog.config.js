...
const BLOG = {
  ...
  NEXT_REVALIDATE_SECOND: process.env.NEXT_PUBLIC_REVALIDATE_SECOND || 4, // 更新内容缓存间隔 单位(秒)；即每个页面有5秒的纯静态期、此期间无论多少次访问都不会抓取notion数据；调大该值有助于节省Vercel资源、同时提升访问速率，但也会使文章更新有延迟。
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Unique', // 您的昵称 例如 tangly1024
  ...
  // 文章URL前缀
  POST_URL_PREFIX: process.env.NEXT_PUBLIC_POST_URL_PREFIX ?? 'thoughts',
  ...
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '你好，我是独特，这里留存了一些我编程时的碎碎念', // 站点描述，被notion中的页面描述覆盖
